...
namespace HRIS_R62.Models.Attendance_Required
{
    public class EmployeeInformation
    {
        ...
        [Required, StringLength(30), Display(Name = "Employee Name Local")]
...
//Here Was Previously SalaryRecordID
        ...
        public virtual SalaryStep? SalaryStep { get; set; } = default!;
