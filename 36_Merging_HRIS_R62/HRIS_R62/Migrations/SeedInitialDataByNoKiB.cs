...
{
    /// <inheritdoc />
    public partial class SeedInitialDataByNoKiB : Migration
    {
        /// <inheritdoc />
            ...
            columns: new[]
{
        ...
        values: new object[,]
        {
            ...
            columns: new[]
            {
                ...
                "DepartmentID", "SectionID", "DesignationID","GradeID", "ShiftEmployeeID","ProximityNumber", "IsOTAllowed", "Gender",
            ...
            {
            {
                ...
                "D001", "S001", "DSG001","GRD001", "SE001","PN123456", true, "Male",
                ...
                "Housewife", new DateTime(1987, 8, 22), "O+", 50000m, 30000m,"SG001","SS001",
            ...
            {
                "E002", "No", "L002", "Alice Smith", "Alice", "C002", "U002", "D002", "D002", "S002", "DSG002","GRD002",
                 "SE002","PN123456", false, "Female", "Mole on neck", "EMP_TYPE_002", "789 Pine St", "321 Oak St", "0987654321",
                ...
                "N/A", null, null,45000m, 35000m,"SG001", "SS002",
                ...
                {
                "E003", "Yes", "L003", "Bob Johnson", "Bob", "C003", "U003", "D003", "D003", "S003", "DSG003","GRD003",
                 "SE003", "PN123456",true, "Male", "Tattoo on arm", "EMP_TYPE_003", "135 Maple St", "246 Birch St", "0112233445",
                ...
                "Teacher", new DateTime(1985, 9, 15), "B+", 55000m, 32000m,"SG003", "SS003",
                ...
                "Engineer", "Friend", "Clear", "Some remarks", "photo3.jpg", "signature3.jpg", "OLD003", "PREV003", "Sunday", new DateTime(2018, 3, 3), "Active"
                    ...
                    {
                "E004", "No", "L004", "Carol White", "Carol", "C004", "U004", "D004", "D004", "S004", "DSG004","GRD004",
                 "SE004", "PN123456",false, "Female", "Scar on right hand", "EMP_TYPE_004", "246 Cedar St", "135 Spruce St", "0223344556",
                ...
                "Engineer", new DateTime(1990, 6, 30), "A+", 48000m, 33000m,"SG004", "SS004",
                ...
                "E005", "Yes", "L005", "David Brown", "David", "C005", "U005", "D005", "D005", "S005", "DSG005","GRD005",
                 "SE005", "PN123456",true, "Male", "Birthmark on neck", "EMP_TYPE_005", "357 Willow St", "468 Aspen St", "0334455667",
                ...
                "N/A", null, null, 47000m, 31000m,"SG005", "SS005",
            ...
            columns: new[] { "DateWiseOfficeTimeID", "ShiftStartDateTime", "ShiftEndDateTime", "ConsideredLunchHour", "BreakDuration", "EmployeeID" },
            values: new object[,]
            {
                { "DOT001", DateTime.Parse("2025-05-01 08:00:00"), DateTime.Parse("2025-05-01 17:00:00"), TimeOnly.Parse("01:00:00"), TimeOnly.Parse("00:30:00"),"E001" },
                { "DOT002", DateTime.Parse("2025-05-01 09:00:00"), DateTime.Parse("2025-05-01 18:00:00"), TimeOnly.Parse("01:00:00"), TimeOnly.Parse("00:45:00"),"E002" },
                { "DOT003", DateTime.Parse("2025-05-02 07:30:00"), DateTime.Parse("2025-05-02 16:30:00"), TimeOnly.Parse("00:45:00"), TimeOnly.Parse("00:30:00"),"E003" },
                { "DOT004", DateTime.Parse("2025-05-03 08:30:00"), DateTime.Parse("2025-05-03 17:30:00"), TimeOnly.Parse("01:00:00"), TimeOnly.Parse("00:15:00"),"E004" },
                { "DOT005", DateTime.Parse("2025-05-04 09:00:00"), DateTime.Parse("2025-05-04 18:00:00"), TimeOnly.Parse("01:00:00"), TimeOnly.Parse("00:30:00"),"E005" }
});
            ...
            columns: new[]
            {
                    "AttendanceRecordID", "AttendanceDate", "InTime", "OutTime", "OTStart", "OTEnd", "TotalRegularHours", "TotalOvertimeHours", "DayType", "AttendanceStatusID","EmployeeID"
            },
            values: new object[,]
            {
                    { "AR001", new DateTime(2025, 5, 27), TimeOnly.Parse("08:00:00"), TimeOnly.Parse("17:00:00"), TimeOnly.Parse("17:30:00"), TimeOnly.Parse("19:00:00"), TimeSpan.Parse("09:00:00"), TimeSpan.Parse("01:30:00"), "Weekday", "P","E001" },
                    { "AR002", new DateTime(2025, 5, 26), TimeOnly.Parse("08:15:00"), TimeOnly.Parse("17:05:00"), TimeOnly.Parse("17:30:00"), TimeOnly.Parse("18:30:00"), TimeSpan.Parse("08:50:00"), TimeSpan.Parse("01:00:00"), "Weekday", "A" ,"E002" },
                    { "AR003", new DateTime(2025, 5, 25), TimeOnly.Parse("08:00:00"), TimeOnly.Parse("17:00:00"), TimeOnly.Parse("00:00:00"), TimeOnly.Parse("00:00:00"), TimeSpan.Parse("09:00:00"), TimeSpan.Parse("00:00:00"), "Weekend", "OL","E003" },
                    { "AR004", new DateTime(2025, 5, 24), TimeOnly.Parse("08:45:00"), TimeOnly.Parse("17:00:00"), TimeOnly.Parse("17:10:00"), TimeOnly.Parse("18:00:00"), TimeSpan.Parse("08:15:00"), TimeSpan.Parse("00:50:00"), "Weekday", "WFH" ,"E004" },
                    { "AR005", new DateTime(2025, 5, 23), TimeOnly.Parse("08:00:00"), TimeOnly.Parse("16:00:00"), TimeOnly.Parse("00:00:00"), TimeOnly.Parse("00:00:00"), TimeSpan.Parse("08:00:00"), TimeSpan.Parse("00:00:00"), "Weekday", "L","E005" }
            });
    ...
    values: new object[,]
            ...
            migrationBuilder.InsertData(
            table: "LateApprovals",
            columns: new[] { "LateApprovalID", "LateDate", "LateReason", "EntryUser", "EmployeeID" },
            values: new object[,]
        {
            { "LA001", DateTime.Parse("2025-06-20"), "Traffic congestion", "admin", "E001" },
            { "LA002", DateTime.Parse("2025-06-21"), "Medical emergency", "admin", "E002" },
            { "LA003", DateTime.Parse("2025-06-22"), "Family issue", "admin", "E003" }
        });
            ...
            migrationBuilder.InsertData(
                table: "OverTimes",
                columns: new[]
                {"OverTimeID","OTDate","OTStartTime","OTEndTime","EmployeeID"},
                values: new object[,]
                {
                    {"OT001",DateTime.Parse("2025-06-20"), new TimeOnly(18, 0, 0), new TimeOnly(20, 0, 0), "E001"},
                    {"OT002",DateTime.Parse("2025-06-21"), new TimeOnly(17, 30, 0),new TimeOnly(19, 0, 0),"E002"},
                    {"OT003",DateTime.Parse("2025-06-22"), new TimeOnly(19, 0, 0), new TimeOnly(22, 15, 0),"E003"}
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[]
                {"ProximityRecordID","ProximityNumber","RecordDate","InTime","OutTime","VerifiedBy","EmployeeID"},

                values: new object[,]
             {
                {"PR001","PX1001", DateTime.Parse("2025-06-20"), new TimeOnly(8, 45, 0), new TimeOnly(17, 0, 0), "System", "E001"},
                {"PR002", "PX1002", DateTime.Parse("2025-06-21"), new TimeOnly(9, 0, 0), new TimeOnly(18, 0, 0), "Admin", "E002"},
                {"PR003", "PX1003", DateTime.Parse("2025-06-22"), new TimeOnly(8, 30, 0), new TimeOnly(17, 15, 0), "Admin", "E003"}
             });
            ...
            migrationBuilder.InsertData(
                table: "ShiftTimes",
                columns: new[]
                {"ShiftID", "ShiftName", "ShiftStart", "ShiftEnd", "StartDate", "EndDate", "ConsideredLunchHour", "BreakDuration", "EmployeeID"},

                values: new object[,]
             {
                {"SFT001", "Morning Shift", DateTime.Parse("2025-06-20T08:00:00"), DateTime.Parse("2025-06-20T16:00:00"), DateTime.Parse("2025-06-01"), DateTime.Parse("2025-12-31"), 1, 0.5m, "E001"},
                {"SFT002", "Evening Shift", DateTime.Parse("2025-06-20T14:00:00"), DateTime.Parse("2025-06-20T22:00:00"), DateTime.Parse("2025-06-01"), DateTime.Parse("2025-12-31"), 1, 0.75m,"E002"},
                { "SFT003", "Night Shift", DateTime.Parse("2025-06-20T22:00:00"), DateTime.Parse("2025-06-21T06:00:00"), DateTime.Parse("2025-06-01"), DateTime.Parse("2025-12-31"), null, 1.0m, "E003"}
             });
